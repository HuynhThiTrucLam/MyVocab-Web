...
//   const topicID = sessionStorage.getItem('topicId'); // Changed to match previous component
...
//         const url = `${baseUrl}Exam?topicId=${topicID}`;
...
//         // Filter exams with skill = "Picture"
...
//           ) : (
//             exams.map((exam) => (
//               <div key={exam.idExam} className="set-box" onClick={() => handleClick(exam)}>
//                 <h3>{exam.nameExam}</h3>
