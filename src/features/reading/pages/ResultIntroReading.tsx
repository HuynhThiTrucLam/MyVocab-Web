    ...
    return (
        <div className="min-h-screen bg-gray-50 relative overflow-hidden">
            ...
            <div className="absolute top-20 right-10 w-80 h-80 rounded-full opacity-20"
                style={{ background: 'linear-gradient(135deg, #10B981 0%, #34D399 100%)' }}></div>
            <div className="absolute bottom-20 right-20 w-40 h-40 rounded-full opacity-30"
                style={{ background: 'linear-gradient(135deg, #10B981 0%, #34D399 100%)' }}></div>
            <div className="absolute top-40 right-40 w-20 h-20 rounded-full opacity-25"
                style={{ background: 'linear-gradient(135deg, #10B981 0%, #34D399 100%)' }}></div>
                    ...
                    <div className="grid grid-cols-2 gap-8 max-w-lg mx-auto mb-12 text-left">
                        <div>
                            <p className="text-gray-600 mb-3">
                                Số lượng câu đúng: <span className="font-semibold text-gray-900">{result?.correctAnswers} câu</span>
                            </p>
                            <p className="text-gray-600">
                                Số lượng câu sai: <span className="font-semibold text-gray-900">{result?.wrongAnswers} câu</span>
                            </p>
                        </div>
                        <div>
                            <p className="text-gray-600 mb-3">
                                Số lượng câu chưa làm: <span className="font-semibold text-gray-900">{result?.notAnswered} câu</span>
                            </p>
                        </div>
                    </div>
